...
public sealed class Program : MyGridProgram
{
     ...
     * Советую ставить блок удалённого управления, для того, чтобы была возможность управлять буром не находять в кабине.
     ...
     * 
     * Hinge, которым управляет наклон головки бура вверх вниз:
     * Hinge shipName
     ...
     * Управление Space/C
     * 
     * Поршень движения базы бура (по умолчанию влево/вправо, но можно использовать как угодно):
     ...
     * rotationCoef - скорость вращения бура вокруг своей оси и вверх вниз по движению мыши (чем больше значение, тем быстрее движение)
